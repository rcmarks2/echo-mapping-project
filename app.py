...
def format_label(loc):
    ...
    city = address.get("city") or address.get("town") or address.get("village") or loc.address.split(',')[0]
...
def result():
    try:
        ...
        if ev_path:
            ...
            ev_not_feasible = False
        else:
            ev_miles = None
            ev_not_feasible = True
        ...
        return render_template("result.html",
                               ...
                               ev_miles=ev_miles,
                               ev_unavailable=ev_not_feasible)
